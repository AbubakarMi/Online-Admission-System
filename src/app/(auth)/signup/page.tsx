...
export default function SignupPage() {
    ...
    const handleSignup = async () => {
        ...
        try {
            ...
            const { user: createdUser, error } = await signUp(email, password, fullName, 'student');
    ...
    const handleContinueToDashboard = () => {
        if (newUser) {
            toast({
                ...
                description: `Welcome to Adustech, ${newUser.name}! Let's get started.`,
            });
    ...
    <div className="min-h-screen bg-gradient-subtle flex items-center justify-center p-6">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8 animate-slide-up">
          ...
          <h1 className="text-3xl font-bold font-display mb-2">Join Adustech</h1>
          <p className="text-muted-foreground">Create your student account to begin your educational journey</p>
        </div>

        <Card className="card-enhanced card-hover animate-slide-up">
          <CardHeader className="pb-6">
            <CardTitle className="text-xl font-display text-center">Create Account</CardTitle>
